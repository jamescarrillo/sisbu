...
<html lang="es">
    <head>
       <jsp:include page="../zinclude_pages/meta_tags.jsp" />
        <title><%=getServletContext().getInitParameter("name.page.base")%> Error 500</title>
            ...
            <div class="dt-root__inner">
                ...
                <div class="dt-page--container">
                    ...
                    <div class="error-page text-center">
                        ...
                        <p class="display-2 text-dark mb-7">Lo siento! Error interno en el servidor</p>
                        <p class="mb-10">La solicitud no se a podido completar, ha ocurrido un error interno en el servidor. Contáctese con el equipo SISBU.</p>
