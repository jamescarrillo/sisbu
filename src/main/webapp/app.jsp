...
<html lang="es">
    <head>
        ...
        <title><%=getServletContext().getInitParameter("name.page.base")%> App</title>
                                            ...
                                            <ul class="dt-app-list">
                                                <li class="dt-app-list__item">
                                                    <a href="javascript:void(0)" class="dt-app-list__link">
                                                        <img src="<%=request.getContextPath()%>/assets/images/icon/icon-account.png" alt="Google Account">
                                                        <span class="dt-app-list__text">Account</span> </a>
                                                </li>
                                                <li class="dt-app-list__item">
                                                    <a href="javascript:void(0)" class="dt-app-list__link">
                                                        <img src="<%=request.getContextPath()%>/assets/images/icon/icon-google.png" alt="Google Search">
                                                        <span class="dt-app-list__text">Search</span> </a>
                                                </li>
                                                <li class="dt-app-list__item">
                                                    <a href="javascript:void(0)" class="dt-app-list__link">
                                                        <img src="<%=request.getContextPath()%>/assets/images/icon/icon-map.png" alt="Google Map">
                                                        <span class="dt-app-list__text">Maps</span> </a>
                                                </li>
                                                <li class="dt-app-list__item">
                                                    <a href="javascript:void(0)" class="dt-app-list__link">
                                                        <img src="<%=request.getContextPath()%>/assets/images/icon/icon-youtube.png" alt="Youtube">
                                                        <span class="dt-app-list__text">YouTube</span> </a>
                                                </li>
                                                <li class="dt-app-list__item">
                                                    <a href="javascript:void(0)" class="dt-app-list__link">
                                                        <img src="<%=request.getContextPath()%>/assets/images/icon/icon-playstore.png" alt="Play Store">
                                                        <span class="dt-app-list__text">Play</span> </a>
                                                </li>
                                                <li class="dt-app-list__item">
                                                    <a href="javascript:void(0)" class="dt-app-list__link">
                                                        <img src="<%=request.getContextPath()%>/assets/images/icon/icon-news.png" alt="Google News">
                                                        <span class="dt-app-list__text">News</span> </a>
                                                </li>
                                                <li class="dt-app-list__item">
                                                    <a href="javascript:void(0)" class="dt-app-list__link">
                                                        <img src="<%=request.getContextPath()%>/assets/images/icon/icon-gmail.png" alt="Google Drive">
                                                        <span class="dt-app-list__text">Gmail</span> </a>
                                                </li>
                                                <li class="dt-app-list__item">
                                                    <a href="javascript:void(0)" class="dt-app-list__link">
                                                        <img src="<%=request.getContextPath()%>/assets/images/icon/icon-drive.png" alt="Google Drive">
                                                        <span class="dt-app-list__text">Drive</span> </a>
                                                </li>
                                                <li class="dt-app-list__item">
                                                    <a href="javascript:void(0)" class="dt-app-list__link">
                                                        <img src="<%=request.getContextPath()%>/assets/images/icon/icon-calendar.png" alt="Calendar">
                                                        <span class="dt-app-list__text">Calendar</span> </a>
                                                </li>
                                                <li class="dt-app-list__item">
                                                    <a href="javascript:void(0)" class="dt-app-list__link">
                                                        <img src="<%=request.getContextPath()%>/assets/images/icon/icon-google-plus.png" alt="Google Plus">
                                                        <span class="dt-app-list__text">Google+</span> </a>
                                                </li>
                                                <li class="dt-app-list__item">
                                                    <a href="javascript:void(0)" class="dt-app-list__link">
                                                        <img src="<%=request.getContextPath()%>/assets/images/icon/icon-translate.png" alt="Translate">
                                                        <span class="dt-app-list__text">Translate</span> </a>
                                                </li>
                                                <li class="dt-app-list__item">
                                                    <a href="javascript:void(0)" class="dt-app-list__link">
                                                        <img src="<%=request.getContextPath()%>/assets/images/icon/icon-photos.png" alt="Photos">
                                ...
                                <ul class="dt-nav">
                                    <li class="dt-nav__item dropdown">
                                        ...
                                        <a href="#" class="dt-nav__link dropdown-toggle" data-toggle="dropdown"
                                           aria-haspopup="true"
                                           aria-expanded="false">
                                            <i class="flag-icon flag-icon-us flag-icon-rounded flag-icon-lg"></i><span>en-uk</span>
                                        </a>
                                        <!-- /dropdown link -->
                            ...
                            <ul class="dt-side-nav">
                                ...
                                <li class="dt-side-nav__item open">
                                    ...
                                    <ul class="dt-side-nav__sub-menu">
                                        ...
                                        <li class="dt-side-nav__item">
                                            <a href="dashboard-real-estate.html" class="dt-side-nav__link" title="Real Estate">
                                        ...
                                        <li class="dt-side-nav__item">
                                            <a href="dashboard-crypto.html" class="dt-side-nav__link" title="Crypto">
                                        ...
                                        <li class="dt-side-nav__item">
                                            <a href="dashboard-crm.html" class="dt-side-nav__link" title="CRM">
                                ...
                                <li class="dt-side-nav__item">
                                    ...
                                    <ul class="dt-side-nav__sub-menu">
                                        <li class="dt-side-nav__item">
                                            <a href="widget.html" class="dt-side-nav__link" title="Classic">
                                                <i class="icon icon-components icon-fw icon-lg"></i>
                                                <span class="dt-side-nav__text">Areas</span>
                                            </a>
                                        </li>


                                        <li class="dt-side-nav__item">
                                            <a href="widget-new.html" class="dt-side-nav__link" title="Modern">
                                ...
                                <li class="dt-side-nav__item">
                                    <a href="layouts.html" class="dt-side-nav__link" title="Layouts">
                                ...
                                <li class="dt-side-nav__item">
                                    <a href="file-upload.html" class="dt-side-nav__link" title="File Upload">
                                ...
                                <li class="dt-side-nav__item">
                                    ...
                                    <ul class="dt-side-nav__sub-menu">
                                        <li class="dt-side-nav__item">
                                            <a href="date-time-pickers.html" class="dt-side-nav__link"
                                ...
                                <li class="dt-side-nav__item">
                                    <a href="drag-drop.html" class="dt-side-nav__link" title="Drag & Drop">
                                ...
                                <!-- Menu Item -->
                                <li class="dt-side-nav__item">
                                    <a href="page-wall.html" class="dt-side-nav__link" title="Wall Page">
                                        <i class="icon icon-wall icon-fw icon-lg"></i>
                                        <span class="dt-side-nav__text">Wall Page</span>
                                    </a>
                                </li>
                                <li class="dt-side-nav__item">
                                    <a href="page-profile.html" class="dt-side-nav__link" title="Profile Page">
                                        <i class="icon icon-profilepage icon-fw icon-lg"></i>
                                        <span class="dt-side-nav__text">Profile Page</span>
                                    </a>
                                </li>
                                <li class="dt-side-nav__item">
                                    <a href="page-login.html" class="dt-side-nav__link" title="Login Page">
                                ...
                                <li class="dt-side-nav__item">
                                    ...
                                    <ul class="dt-side-nav__sub-menu">
                                        <li class="dt-side-nav__item">
                                            <a href="view-grid.html" class="dt-side-nav__link" title="Basic Grid">
                                                <i class="icon icon-grid icon-fw icon-lg"></i>
                                        ...
                                        <li class="dt-side-nav__item">
                                            <a href="view-grid-1.html" class="dt-side-nav__link" title="Advanced Grid">
                                ...
                                <li class="dt-side-nav__item">
                                    ...
                                    <ul class="dt-side-nav__sub-menu">
                                        <li class="dt-side-nav__item">
                                            <a href="view-list.html" class="dt-side-nav__link" title="Basic List">
                                                <i class="icon icon-list icon-fw icon-lg"></i>
                                        ...
                                        <li class="dt-side-nav__item">
                                            <a href="view-list-1.html" class="dt-side-nav__link" title="Advanced List">
