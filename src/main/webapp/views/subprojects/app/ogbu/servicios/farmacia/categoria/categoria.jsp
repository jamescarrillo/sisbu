...
<div class="row">
    <div class="col-xl-12" id="btnListaCategoria">
        ...
        <div class="card overflow-hidden">
            ...
            <div class="card-header bg-transparent">
                <h4 class="mb-0" id="titleManagerCategoria">[ 0 ] CATEGORÍAS</h4>
            ...
            <div class="card-body pt-0">
                <form id="FrmCategoria">
                    <div class="input-group search-box" style="max-width: 100%;">
                        <input type="search" id="txtFilterCategoria" class="form-control form-control-sm" placeholder="Filter Nombre...">
                        <div class="input-group-append">
                            <span class="search-icon"><i class="icon icon-search icon-lg"></i></span>
                            <button type="submit" class="btn btn-primary btn-sm mr-2"><i class="icon icon-search icon-fw"></i> BUSCAR</button>
                        </div>
                        <button type="button" class="btn btn-primary btn-sm" id="btnOpenNewCategoria"data-toggle="tooltip" title="Agregar Categoría" ><i class="icon icon-addnew"></i></button>
                    </div>
                </form>
    ...
    <div class="col-xl-12" id="btnOpenCategoria" style="display: none">
        ...
        <div class="card overflow-hidden p-5">
            <div class="card-header bg-transparent">
                <h4 class="mb-0 text-center" id="txtTituloModalMan"> CATEGORÍAS</h4>
            ...
            <form id="FrmCategoriaModal"> 
                <div class="row">
                    ...
                    <div class="form-group col-lg-4 col-sm-6">
                        ...
                        <input class="form-control form-control-sm" id="txtNombreCategoria" type="text" placeholder="NOMBRE">
                    </div>
...
<div class="modal fade" id="modalCargandoCategoria" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog" style="padding-top: 18%; overflow-y: visible; display: none;" aria-hidden="true">
