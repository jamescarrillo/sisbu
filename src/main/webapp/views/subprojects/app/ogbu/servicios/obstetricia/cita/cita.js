...
function processAjaxCita() {
    ...
    if (beanRequestCita.operation == "servicio/paginate") {
        ...
        parameters_pagination += "?type_service=4&type_request=" + document.querySelector("#txtTypeRequestCita").value.toLowerCase();
...
function toListCita(beanPagination) {
    ...
    if (beanPagination.count_filter == 0) {
        ...
        row +=
            ...
            `;
        document.querySelector("#tbodyCita").innerHTML += row; showAlertTopEnd('warning', 'No se encontraron resultados');
        return;
    }
