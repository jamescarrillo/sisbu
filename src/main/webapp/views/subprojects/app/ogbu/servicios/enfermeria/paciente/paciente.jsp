                ...
                <div id="tab-pane-17" class="tab-pane ">
                    <div class="form-group form-row">
                        <div class="col-11 text-center">
                            <label id="titleManagerTriaje" for="normal-input-3"
                        ...
                        <div class="float-right">
                            <button type="button" class="btn btn-primary btn-sm" id="btnOpenNewTriajePaciente"
                                data-toggle="tooltip" title="Agregar Triaje"><i class="icon icon-addnew"></i> </button>
                        </div>
                    </div>
                    ...
                    <form id="FrmTriajePaciente">
                        <div class="row">
                            ...
                            <div class="col-lg-12 col-sm-12 text-center">
                                <button id="btnCancelarTriaje" type="button" class="btn btn-outline-primary btn-sm"><i
...
<div class="modal fade" id="modalCargandoTriaje" data-backdrop="static" data-keyboard="false" tabindex="-1"
    role="dialog" style="padding-top: 18%; overflow-y: visible; display: none;" aria-hidden="true">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            <div class="modal-body">
