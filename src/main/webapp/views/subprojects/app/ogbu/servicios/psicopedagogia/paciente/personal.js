...
document.addEventListener("DOMContentLoaded", function () {
    ...
    document.querySelector("#btn-selecionar-personal").onclick = function () {
        ...
        document.querySelector("#txtPersonal").value = personalSelected.nombre.toUpperCase() + " " + personalSelected.apellido_pat.toUpperCase() + " " + personalSelected.apellido_mat.toUpperCase();
    ...
    document.querySelector("#btnCancelSelectionPersonal").onclick = function () {
        ...
        document.querySelector("#txtPersonal").value = "";
    };
