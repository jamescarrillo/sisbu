                ...
                <div class="col-lg-8 col-12 mb-3">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control form-control-sm" id="txtEscuelaAtendido"
                            aria-describedby="nombre" placeholder="Click en el bot�n para seleccionar. . ." disabled="">
                        <div class="input-group-append">
                    ...
                    <div class="dt-card__body">
                        <div class="dt-widget dt-widget-hl-item dt-widget-hl-item-space dt-widget-mb-item dt-widget-hover-bg"
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="form-group">
                                        <label for="txtNumCursosDesaprobadosFichaSocieconomica">N� CURSOS DESAPROBADOS
                                            <i class="fa fa-question-circle" aria-hidden="true" data-toggle="popover"
                                                data-trigger="hover" data-placement="top" title=""
                                                data-content="Indica la cantidad de cursos desaprobados en todo tu historial acad�mico. Si no tienes ning�n curso ingresa 0"
                                                style="cursor: pointer" data-original-title=""></i>
                                        </label>
                                        <input type="number" class="form-control form-control-sm"
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="form-group">
                                        <label for="txtNumCursosAbandonadosFichaSocieconomica">N� CURSOS ABANDONADOS
                                            <i class="fa fa-question-circle" aria-hidden="true" data-toggle="popover"
                                                data-trigger="hover" data-placement="top" title=""
                                                data-content="Indica la cantidad de cursos abandonados en todo tu historial acad�mico. Si no tienes ning�n curso ingresa 0"
                                                style="cursor: pointer" data-original-title=""></i>
                                        </label>
                                        <input type="number" class="form-control form-control-sm"
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        <label for="txtDomicilioPadreFichaSocieconomica">DOMICILIO DEL PADRE
                                            <i class="fa fa-question-circle" aria-hidden="true" data-toggle="popover"
                                                data-trigger="hover" data-placement="top" title=""
                                                data-content="Indica el domicilio actual del padre. Si no tienes esta informaci�n deja la caja de texto en blanco"
                                                style="cursor: pointer" data-original-title=""></i>
                                        </label>
                                        <input type="text" class="form-control form-control-sm text-uppercase"
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        <label for="txtDomicilioMadreFichaSocieconomica">DOMICILIO DE LA MADRE
                                            <i class="fa fa-question-circle" aria-hidden="true" data-toggle="popover"
                                                data-trigger="hover" data-placement="top" title=""
                                                data-content="Indica el domicilio actual de la madre. Si no tienes esta informaci�n deja la caja de texto en blanco"
                                                style="cursor: pointer" data-original-title=""></i>
                                        </label>
                                        <input type="text" class="form-control form-control-sm text-uppercase"
                                ...
                                <div class="col-lg-4 col-sm-6">
                                    <div class="form-group">
                                        <label for="txtRelacionPadresFichaSocieconomica">RELACI�N DE PADRES</label>
                                        <select class="form-control form-control-sm sisbu-cursor-mano"
                                ...
                                <div class="col-lg-8 mb-4">
                                    ...
                                    <div class="input-group">
                                        <select class="form-control form-control-sm sisbu-cursor-mano"
                                            ...
                                            <option value="OTRO">OTRA OPCI�N</option>
                                        </select>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control form-control-sm"
                                            ...
                                            <option value="-1">Seleccionar. . .</option>
                                            <option value="AMBOS PADRES">AMBOS PADRES</option>
                                            <option value="SOLO PAP�">SOLO PAP�</option>
                                            <option value="SOLO MAM�">SOLO MAM�</option>
                                            <option value="HERMANOS">HERMANOS</option>
                                    ...
                                    <div class="row mt-1">
                                        ...
                                        <div class="col-lg-2 col-md-3 col-sm-4">
                                            <div class="form-group custom-control custom-checkbox">
                                                ...
                                                <label class="custom-control-label sisbu-cursor-mano"
                                                    for="checkboxTelefonoService">Tel�fono</label>
                                            </div>
                                        </div>
                                        <div class="col-lg-2 col-md-3 col-sm-4">
                                            <div class="form-group custom-control custom-checkbox">
