    ...
    <div class="col-xl-12" id="btnListaEntrada">
        ...
        <div class="card overflow-hidden">
            ...
            <div class="card-header bg-transparent">
                <h4 class="mb-0" id="titleManagerEntrada">[ 0 ] UNIDADES DE MEDIDA</h4>
            ...
            <div class="card-body pt-0">
                <form id="FrmEntrada">
                    <div class="input-group search-box" style="max-width: 100%;">
                        ...
                        <button type="button" class="btn btn-primary btn-sm" id="btnOpenNewEntrada"data-toggle="tooltip" title="Agregar Unidad de Medida" ><i class="icon icon-addnew"></i></button>
                    </div>
                </form>
                ...
                <div class="row mt-2">
                    ...
                    <div class="col-md-10 col-sm-9 col-8">
                        <nav aria-label="Page navigation example">
                            <ul id="paginationEntrada" class="pagination pagination-sm justify-content-end">
                            </ul>
                        </nav>  
                    </div>
                </div>
            ...
            <form id="FrmEntradaModal"> 
                <div class="row">
                    ...
                    <div class="form-group col-lg-4 col-sm-6">
                        <label for="txtNombreEntrada">Nombre</label>
                        <input class="form-control form-control-sm" id="txtNombreEntrada" type="text" placeholder="NOMBRE">
                    </div>
                    <div class="form-group col-lg-4 col-sm-6">
                        <label for="txtAbreviaturaEntrada">Abreviatura</label>
                        <input class="form-control form-control-sm" id="txtAbreviaturaEntrada" type="text" placeholder="ABREVIATURA">
                    </div>
...
<div class="modal fade" id="modalCargandoEntrada" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog" style="padding-top: 18%; overflow-y: visible; display: none;" aria-hidden="true">
