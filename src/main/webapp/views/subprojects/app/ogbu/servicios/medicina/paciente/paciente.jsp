                    ...
                    <table class="table mb-0 mt-2">
                        <thead>
                            <tr>
                                ...
                                <th class="text-uppercase" scope="col" >H. CLÍNICA</th>
                            </tr>
                        </thead>
            ...
            <div class="tab-content p-5 ">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="form-group">
                                ...
                                <input disabled type="email" class="form-control" id="normal-input-1" placeholder="Enter email">
                            </div>
                        </div>
                        <div class="col-lg-4 col-sm-6">
                            <div class="form-group">
                        ...
                        <div class="col-lg-4 col-sm-12">
                            <div class="form-group">
                                ...
                                <select disabled class="form-control form-control-sm" id="simple-select">
                                    <option selected  value="1">MASCULINO</option>
                                    <option  value="2">FEMENINO</option>
                                </select>
                            </div>
                ...
                <div id="tab-pane-16" class="tab-pane ">
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="form-group">
                                ...
                                <select  class="form-control form-control-sm" id="txtSeguroPaciente">
                                    ...
                                    <option  value="3">OTRO</option>
                                    <option selected  value="4">SIN DEFINIR</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-sm-6" >
                            ...
                            <div class="form-group">
                                <textarea class="form-control" id="txtAntFamiliPaciente" rows="3" placeholder="ANTECEDENTES FAMILIARES"></textarea>
                            </div>
                        </div>
                        <div class="col-lg-4 col-sm-6" >
                            <label for="txtAntPersonalPaciente">ANTECEDENTES PERSONALES</label>
                            <div class="form-group">
                                <textarea class="form-control" id="txtAntPersonalPaciente" rows="3" placeholder="ANTECEDENTES PERSONALES"></textarea>     
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-sm-6" >
                            ...
                            <div class="form-group">
                                <textarea class="form-control" id="txtAlergiaPaciente" rows="3" placeholder="ALERGIAS"></textarea>
                            </div>
                        </div>
                    </div>   
                ...
                <div id="tab-pane-17" class="tab-pane ">
                    ...
                    <div class="form-group form-row">
                        <label for="normal-input-3" class="col-md-11 col-sm-7 col-xs-8 col-form-label col-form-label-lg text-sm-center text-primary">LISTA DE DIAGNÓSTICOS</label>
                ...
                <div class="row" >
                    <div class="col-lg-6 col-sm-6">
                        <div class="form-group ">
                            ...
                            <input  type="text" class="form-control" id="txtPaPaciente" placeholder="PA">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-sm-6">
                        <div class="form-group ">
                            ...
                            <select class="form-control form-control-sm " id="txtZonaControlPaciente">
                                ...
                                <option selected  value="1">MSD</option>
                    ...
                    <div class="col-lg-6 col-sm-6">
                        <div class="form-group ">
                            ...
                            <select class="form-control form-control-sm " id="txtPosicionPaciente">
                                ...
                                <option selected  value="1">DECÚBITO DORSAL</option>
                    ...
                    <div class="col-lg-6 col-sm-6">
                        <div class="form-group ">
                            ...
                            <input type="text" class="form-control" id="txtFcPaciente" placeholder="FC">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-sm-6">
                        <div class="form-group ">
                            ...
                            <input  type="text" class="form-control" id="txtFrPaciente" placeholder="FR">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-sm-6">
                        <div class="form-group ">
                            ...
                            <input type="text" class="form-control" id="txtTPaciente" placeholder="T°">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-sm-6">
                        <div class="form-group ">
                            ...
                            <input type="text" class="form-control" id="txtSoPaciente" placeholder="S02">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-sm-6">
                        <div class="form-group ">
                            ...
                            <input  type="text" class="form-control" id="txtGlicemiaPaciente" placeholder="GLICEMIA">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-sm-6">
                        <div class="form-group ">
                            ...
                            <input  type="text" class="form-control" id="txtPesoPaciente" placeholder="PESO">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-sm-6">
                        <div class="form-group ">
                            ...
                            <input  type="text" class="form-control" id="txtTallaPaciente" placeholder="TALLA">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-sm-6">
                        <div class="form-group ">
                            ...
                            <input disabled type="text" class="form-control" id="txtImcPaciente" placeholder="IMC">
                        </div>
                    </div>
