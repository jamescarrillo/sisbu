                    ...
                    <form id="FrmDiagnosticoPaciente">
                        <div class="row" >
                            ...
                            <div class="col-lg-4 col-sm-6">
                                ...
                                <div class="form-group">
                                    <textarea class="form-control form-control-sm" id="txtEnfermedadPaciente" rows="3" placeholder="ENFERMEDAD ACTUAL"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-sm-6">
                                ...
                                <div class="form-group">
                                    <textarea class="form-control form-control-sm" id="txtDxPaciente" rows="3" placeholder="Dx"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-sm-12">
                                ...
                                <div class="form-group">
                                    <textarea class="form-control form-control-sm" id="txtTtoPaciente" rows="3" placeholder="Tto"></textarea>
                                </div>
                            </div>
                            <div class="col-lg-12 col-sm-12 text-center">
                                <button id="btnCancelarDiagnostico" type="button" class="btn btn-outline-primary btn-sm" ><i class="icon icon-reply"></i> CANCELAR</button>
