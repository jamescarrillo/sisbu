            ...
            <form id="FrmPaciente">
                <div class="form-row">
                    <div class="col-4 form-group">
                        <label for="txtFilterEscuelaPaciente">Escuela Profesional</label>
                        <input type="search" id="txtFilterEscuelaPaciente" class="form-control form-control-sm"
                            placeholder="Filtrar por Escuela ...">
                    </div>
                    <div class="col-4 form-group">
                        <label for="txtFilterCicloPaciente">Ciclo Acad&eacute;mico</label>
                        <input type="search" id="txtFilterCicloPaciente" class="form-control form-control-sm"
