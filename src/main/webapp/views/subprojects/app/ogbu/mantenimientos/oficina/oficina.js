...
document.addEventListener("DOMContentLoaded", function () {
    ...
    $("#modalCargandoOficina").on('shown.bs.modal', function () {
        if (!$('#ventanaModalOficina').hasClass("show")) {
            beanRequestOficina.operation = "paginate";
            beanRequestOficina.type_request = "GET";
            console.log("cerrado");
        }
    ...
    document.querySelector("#btnOpenNewArea").onclick = function () {
        ...
        document.querySelector("#txtNombreAbreviadoArea").value = "";
        //SET TITLE MODAL
        document.querySelector("#txtTituloModalArea").innerHTML = "REGISTRAR AREA";
        //OPEN MODEL
        $('#ventanaModalArea').modal('show');
    };

    $("#modalCargandoArea").on('shown.bs.modal', function () {
        if (!$('#ventanaModalArea').hasClass("show")) {
            beanRequestArea.operation = "paginate";
            beanRequestArea.type_request = "GET";
            console.log("cerrado");
        }
    ...
    document.querySelectorAll('.ver-area').forEach(btn => {
        ...
        btn.onclick = function () {
            ...
            if (oficinaSelected != undefined) {
                ...
                processAjaxArea();
                document.querySelector("#txtTituloModalVer").innerHTML = oficinaSelected.nombre;
                $('#ventanaModalVer').modal("show");
            } else {
    ...
    if (beanRequestArea.operation == "paginate") {
        ...
        if (beanRequestArea.operation == "delete") {
            ...
            json = {
                ...
                "nom_abreviado": document.querySelector("#txtNombreAbreviadoArea").value,
...
function toListArea(beanPagination) {
    document.querySelector("#tablaArea-height").style.height = "175px";
    document.querySelector("#tbodyArea").innerHTML = "";
    document.querySelector("#titleManagerArea").innerHTML = "[ " + beanPagination.length + " ]  ";
    ...
    document.querySelectorAll('.editar-area').forEach(btn => {
        ...
        btn.onclick = function () {
            ...
            if (areaSelected != undefined) {
                ...
                document.querySelector("#txtNombreAbreviadoArea").value = areaSelected.nom_abreviado;
                //SET VALUES MODAL
                document.querySelector("#txtTituloModalArea").innerHTML = "EDITAR AREA";
                $('#ventanaModalArea').modal("show");
