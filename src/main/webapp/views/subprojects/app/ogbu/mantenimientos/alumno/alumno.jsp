        ...
        <div class="overflow-hidden" id="btnListaAlumno">
            ...
            <div class="card-body p-0">
                    ...
                    <div class="form-row justify-content-center">
                        ...
                        <div class="col-12 form-group">
                            <div class="input-group search-box mw-100">
                                ...
                                <button type="button" class="btn btn-primary btn-sm ml-4" id="btnOpenNewAlumno"
                                    data-toggle="tooltip" title="Agregar Alumno"><i
                ...
                <div class="w-100 ps-custom-scrollbar mb-0 ps pb-5">
                    <!-- Card Body -->
                    <div class="dt-card__body p-0 dt-social-card border border-w-2 border-light-teal"
                        ...
                        <!-- /card heading -->
                        <!-- Widget -->
                        <div class="dt-widget dt-widget-hover " id="tbodyAlumno">
                        </div>
                        <!-- /widget -->
                        <!-- /card body -->
                    </div>
                                ...
                                <div class="card-body p-3">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3 col-sm-4 col-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control form-control-sm"
                                                    ...
                                                    placeholder="Ingrese n� documento. . ." maxlength="8">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-3 col-sm-4 mb-3 col-6">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control form-control-sm"
                                                    id="txtFechaNacAlumno" placeholder="DD/MM/AAAA">
                                                <div class="input-group-append">
                                                    <button type="button" id="btnEliminarFechaNacAlumno"
                                        ...
                                        <div class="col-lg-3 col-sm-4 col-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control form-control-sm"
                                                    id="txtApPaternoAlumno" placeholder="AP. PATERNO" maxlength="45">
                                            </div>
                                        </div>
                                        <div class="col-lg-3 col-sm-4 col-6">
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <label for="txtDireccionActualAlumno">DIRECCION ACTUAL
                                                    <i class="fa fa-question-circle" aria-hidden="true"
                                                        ...
                                                        title=""
                                                        data-content="Direcci�n donde vives actualmente. Si vives en un caser�o ingresa tu direcci�n y luego agrega tu caser�o separado por un gui�n. Ejm: #LOS PINOS - SAN MART�N"
                                                        style="cursor: pointer" data-original-title=""></i>
                                                </label>
                                                <input type="text" class="form-control form-control-sm"
                                                    id="txtDireccionActualAlumno"
                                                    placeholder="Ingrese direcci�n actual. . ." maxlength="80">
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-sm-6 ">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control form-control-sm"
                                                    ...
                                                    placeholder="Ingrese direcci�n de procedencia" maxlength="80">
                                            </div>
                                        </div>
                            ...
                            <div id="tab-datos-laborales">
                                ...
                                <div class="card-body p-3 ">
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                <label for="txtTipoPersonalAlumno">TIPO DE PERSONAL
                                                    <i class="fa fa-question-circle" aria-hidden="true"
                                                        data-toggle="popover" data-trigger="hover" data-placement="top"
                                                        title=""
                                                        data-content="Si no labora en la Universidad selecciona la opci�n 'OTRO'"
                                                        style="cursor: pointer" data-original-title=""></i>

                                                </label>
                                                <select class="form-control form-control-sm sisbu-cursor-mano"
                                                    id="txtTipoPersonalAlumno">
                                                    <option value="-1">Seleccione... </option>
                                        ...
                                        <div class="col-lg-3 col-sm-4 col-6 mb-3">
                                            <label for="txtCicloAlumno">CICLO DE INGRESO
                                                <i class="fa fa-question-circle" aria-hidden="true"
                                                    data-toggle="popover" data-trigger="hover" data-placement="top"
                                                    title=""
                                                    data-content="Ciclo que ingresaste. Si no es Alumno deja la caja de texto en blanco"
                                                    style="cursor: pointer" data-original-title=""></i>
                                            </label>
                                            <div class="input-group">
                                                <input type="text" class="form-control form-control-sm"
                                        ...
                                        <div class="col-lg-3 col-sm-4 col-6">
                                            <div class="form-group">
                                                <label for="txtCodigoAlumno">C�DIGO
                                                    <i class="fa fa-question-circle" aria-hidden="true"
                                                        data-toggle="popover" data-trigger="hover" data-placement="top"
                                                        title=""
                                                        data-content="Es el c�digo �nico de estudiante. Si a�n no sabes cual es tu c�digo, deja la caja de texto en blanco. Si no es Alumno deja la caja de texto en blanco"
                                                        style="cursor: pointer" data-original-title=""></i>
                                                </label>
                                                <input type="text" class="form-control form-control-sm"
                                                    id="txtCodigoAlumno" placeholder="Ingrese C�digo. . ."
                                                    maxlength="7">
                                            </div>
                                        </div>
                                        <div class="col-lg-3 col-sm-4 col-6">
                                            <div class="form-group">
                                                <label for="txtCachimboAlumno">CACHIMBO
                                                    <i class="fa fa-question-circle" aria-hidden="true"
                                                        data-toggle="popover" data-trigger="hover" data-placement="top"
                                                        title=""
                                                        data-content="Si no es Alumno selecciona la opci�n 'NO'"
                                                        style="cursor: pointer" data-original-title=""></i>

                                                </label>
                                                <select class="form-control form-control-sm sisbu-cursor-mano"
                                                    id="txtCachimboAlumno">
                                                    <option value="-1">Seleccione... </option>
                                            ...
                                            <div class="form-group">
                                                <label for="txtTipoColegioAlumno">TIPO DE COLEGIO
                                                    <i class="fa fa-question-circle" aria-hidden="true"
                                                        data-toggle="popover" data-trigger="hover" data-placement="top"
                                                        title=""
                                                        data-content="Si no es Alumno selecciona la opci�n 'OTRO'"
                                                        style="cursor: pointer" data-original-title=""></i>

                                                </label>
                                                <select class="form-control form-control-sm sisbu-cursor-mano"
                                                    id="txtTipoColegioAlumno">
                                                    <option value="-1">Seleccione. . .</option>
                                        ...
                                        <div class="col-lg-12 col-sm-6 mb-3">
                                            <label for="txtEscuelaAlumno">ESCUELA
                                                <i class="fa fa-question-circle" aria-hidden="true"
                                                    data-toggle="popover" data-trigger="hover" data-placement="top"
                                                    title=""
                                                    data-content="Carrera profesional a la que ingresaste. Si no es Alumno deja la caja de texto en blanco"
                                                    style="cursor: pointer" data-original-title=""></i>
                                            </label>
                                            <div class="input-group">
                                                <input type="text" class="form-control form-control-sm"
...
<div class="modal fade" id="modalCargandoAlumno" data-backdrop="static" data-keyboard="false" tabindex="-1"
                        ...
                        <div class="row pl-5 pr-5 mb-2">
                            <div class="table-responsive">
                                <table class="table mb-0 table-fluid">
                                    <thead>
                                        <tr>
                                            <th class="align-middle text-left">Ocupaci�n</th>
                                        </tr>
                                    </thead>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content" style="border-color: #0085c1; border-width: 4px;">
            ...
            <div class="modal-body pb-0 pt-0">
                <div class="row">
                    <div class="col-12">
                        <input type="hidden" id="pageCicloC" value="1">
                        <form id="FrmCicloC">
                            <div class="row mt-3">
                                <div class="input-group col-12">
                                    <input type="text" id="txtFilterCicloC" class="form-control form-control-sm mr-3"
                                        placeholder="INGRESE FILTRO . . .">
                                    <button type="submit" id="btnBuscarCicloC" class="btn btn-primary btn-xs"
                                        data-toggle="tooltip" title="Buscar Ciclo"><i class="fa fa-search"
                                            aria-hidden="true"></i>
                                        BUSCAR</button>
                                </div>
                            </div>
                        ...
                        <div class="row mt-2 mb-2" style="display: none">
                            ...
                            <div class="col-sm-8 mt-2">
                                <nav aria-label="Page navigation">
                                    <ul id="paginationCicloC" class="pagination justify-content-end">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-outline-primary btn-xs" data-dismiss="modal"
                    id="btnCancelSelectionCicloC"><i class="fas fa-ban"></i>
                    CANCELAR</button>
