    ...
    document.querySelector("#btn-selecionar-distritoc").onclick = function () {
        ...
        switch (distrito_option) {
            case "procedencia":
                ...
                document.querySelector("#txtDistritoProcedenciaAlumno").value = distritoCSelected.nombre.toUpperCase();
                break;
                      default:
                //actual
                distritoActualSelected = distritoCSelected;
                document.querySelector("#txtDistritoActualAlumno").value = distritoCSelected.nombre.toUpperCase();
                break;
        }
