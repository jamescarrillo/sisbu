        ...
        <div class="overflow-hidden">
            ...
            <div class="card-body p-0">
                ...
                <div class="card-header card-nav bg-transparent mb-5">
                    <ul class="card-header-links nav nav-underline text-uppercase border-bottom" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link" id="titleManagerDepartamento" style="cursor: pointer">DEPARTAMENTOS</a>
                            <input type="hidden" id="pageDepartamento" value="1">
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="titleManagerProvincia" style="cursor: pointer">PROVINCIAS</a>
                            <input type="hidden" id="pageProvincia" value="1">
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active" id="titleManagerDistrito" style="cursor: pointer">DISTRITOS </a>
                ...
                <div class="tab-content">
                    ...
                    <div id="tab-departamentos" style="display: none">
                        ...
                        <form id="FrmDepartamento">
                            <div class="input-group search-box" style="max-width: 100%;">
                                <input type="search" id="txtFilterNombreDepartamento"
                                    class="form-control form-control-sm" placeholder="FILTRO..." data-toggle="tooltip"
                                    data-placement="left" data-original-title="Buscar">
                                <button type="submit" class="search-icon">
                                    <i class="icon icon-search icon-lg"></i></button>

                                <button type="button" class="btn btn-primary btn-sm ml-4" id="btnOpenNewDepartamento"
                                    data-toggle="tooltip" title="Agregar Departamento"><i
                                    ...
                                    <form id="FrmDepartamentoModal">
                                        <div class="row">
                                            <div class="form-group col-12">
                                                ...
                                                <input class="form-control form-control-sm" id="txtNombreDepartamento"
                                                    type="text" placeholder="NOMBRE">
                                            </div>

                                            <div class="form-group col-12 text-center">
                                                <button type="button" id="btnCancelarDepartamento"
                                                    class="btn btn-outline-primary btn-sm"><i
                                                        class="icon icon-reply"></i> CANCELAR</button>
                                                <button type="submit" id="btnGuardarDepartamento"
                    ...
                    <div id="tab-provincias" style="display: none">
                        ...
                        <form id="FrmProvincia">
                            <div class="input-group search-box" style="max-width: 100%;">
                                <input type="search" id="txtFilterNombreProvincia" class="form-control form-control-sm"
                                    placeholder="FILTRO. . ." data-toggle="tooltip" data-placement="left"
                                    data-original-title="Buscar">
                                <button type="submit" class="search-icon">
                                    <i class="icon icon-search icon-lg"></i></button>

                                <button type="button" class="btn btn-primary btn-sm ml-4" id="btnOpenNewProvincia"
                                    data-toggle="tooltip" title="Agregar Provincia"><i
                                        class="icon icon-addnew"></i></button>
                                    ...
                                    <form id="FrmProvinciaModal">
                                        <div class="row">
                                            <div class="form-group col-12">
                                                ...
                                                <input class="form-control form-control-sm" id="txtNombreProvincia"
                                                    type="text" placeholder="NOMBRE">
                                            </div>
                                            <div class=" form-group col-lg-12 ">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" class="form-control form-control-sm"
                                                        id="txtDepartamentoProvincia" aria-describedby="nombre"
                                                        placeholder="Click en el bot�n para seleccionar. . ."
                                                        disabled="">
                                                    <div class="input-group-append">
                                                        <button type="button" id="btnSeleccionarDepartamento"
                                            ...
                                            <div class="form-group col-12 text-center">
                                                <button type="button" id="btnCancelarProvincia"
                                                    class="btn btn-outline-primary btn-sm"><i
                                                        class="icon icon-reply"></i> CANCELAR</button>
                                                <button type="submit" id="btnGuardarProvincia"
                                                    class="btn btn-primary btn-sm">GUARDAR</button>
                    ...
                    <div id="tab-distritos">
                        ...
                        <form id="FrmDistrito">
                            <div class="input-group search-box mw-100">
                                <input type="search" id="txtFilterNombreDistrito" class="form-control form-control-sm"
                                    placeholder="FILTRO..." data-toggle="tooltip" data-placement="left"
                                    data-original-title="Buscar">
                                <button type="submit" class="search-icon">
                                    <i class="icon icon-search icon-lg"></i></button>

                                <button type="button" class="btn btn-primary btn-sm ml-4" id="btnOpenNewDistrito"
                                    data-toggle="tooltip" title="Agregar Distrito"><i
                                        class="icon icon-addnew"></i></button>
                                    ...
                                    <form id="FrmDistritoModal">
                                        <div class="row">
                                            <div class="form-group col-12">
                                                ...
                                                <input class="form-control form-control-sm" id="txtNombreDistrito"
                                                    type="text" placeholder="NOMBRE">
                                            </div>
                                            <div class="form-group  col-lg-12 ">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" class="form-control form-control-sm"
                                                        id="txtProvinciaDistrito" aria-describedby="nombre"
                                                        placeholder="Click en el bot�n para seleccionar. . ."
                                                        disabled="">
                                                    <div class="input-group-append">
                                                        <button type="button" id="btnSeleccionarProvincia"
                                                            class="btn btn-primary btn-sm"><i
                                                                class="icon icon-subscribe"></i></button>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-group  col-lg-12 text-center">
                                                <button type="button" id="btnCancelarDistrito"
                                                    class="btn btn-outline-primary btn-sm"><i
                                                        class="icon icon-reply"></i> CANCELAR</button>
                                                <button type="submit" id="btnGuardarDistrito"
                                                    class="btn btn-primary btn-sm">GUARDAR</button>
...
<div class="modal fade" id="modalCargandoDistrito" data-backdrop="static" data-keyboard="false" tabindex="-1"
...
<!-- provincia-->
<div class="modal fade" id="modalCargandoProvincia" data-backdrop="static" data-keyboard="false" tabindex="-1"
    role="dialog" style="padding-top: 18%; overflow-y: visible; display: none;" aria-hidden="true">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            <div class="modal-body">
...
<div class="modal fade" id="modalCargandoDepartamento" data-backdrop="static" data-keyboard="false" tabindex="-1"
    role="dialog" style="padding-top: 18%; overflow-y: visible; display: none;" aria-hidden="true">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            <div class="modal-body">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content" style="border-color: #0085c1; border-width: 4px;">
            ...
            <div class="modal-body pb-0 pt-0">
                <div class="row">
                    <div class="col-12">
                        <input type="hidden" id="pageProvinciaC" value="1">
                        <form id="FrmDoctorC">
                            <div class="row mt-3">
                                <div class="input-group col-12">
                                    <input type="text" id="txtFilterProvinciaC"
                                        class="form-control form-control-sm mr-3" placeholder="INGRESE FILTRO . . .">
                                    <button type="submit" id="btnBuscarProvinciaC" class="btn btn-primary btn-xs"
                        ...
                        <div class="row mt-2 mb-2" style="display: none">
                            ...
                            <div class="col-sm-8 mt-2">
                                <nav aria-label="Page navigation">
                                    <ul id="paginationProvinciaC" class="pagination justify-content-end">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-outline-primary btn-xs" data-dismiss="modal"
                    id="btnCancelSelectionProvinciaC"><i class="fas fa-ban"></i>
                    CANCELAR</button>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content" style="border-color: #0085c1; border-width: 4px;">
            ...
            <div class="modal-body pb-0 pt-0">
                <div class="row">
                    <div class="col-12">
                        <input type="hidden" id="pageDepartamentoC" value="1">
                        <form id="FrmDepartamentoC">
                            <div class="row mt-3">
                                <div class="input-group col-12">
                                    <input type="text" id="txtFilterDepartamentoC"
                                        class="form-control form-control-sm mr-3" placeholder="INGRESE FILTRO . . .">
                                    <button type="submit" id="btnBuscarDepartamentoC" class="btn btn-primary btn-xs"
                                        data-toggle="tooltip" title="Buscar Pregunta"><i class="fa fa-search"
                                            aria-hidden="true"></i>
                                        BUSCAR</button>
                                </div>
                        ...
                        <div class="row mt-2 mb-2" style="display: none">
                            ...
                            <div class="col-sm-8 mt-2">
                                <nav aria-label="Page navigation">
                                    <ul id="paginationDepartamentoC" class="pagination justify-content-end">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-outline-primary btn-xs" data-dismiss="modal"
                    id="btnCancelSelectionDepartamentoC"><i class="fas fa-ban"></i>
                    CANCELAR</button>
