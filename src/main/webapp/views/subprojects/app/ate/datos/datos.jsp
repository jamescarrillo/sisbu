                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input  type="text" class="form-control form-control-sm" id="txtDireccionActualPaciente" placeholder="DIRECCION ACTUAL">
                                </div>
                            </div>
                            <div class="col-lg-4 col-sm-12">
                                <div class="form-group">
                                    <label for="txtDireccionProcePaciente">DIRECCION PROCEDENCIA</label>
                                    <input  type="text" class="form-control form-control-sm" id="txtDireccionProcePaciente" placeholder="DIRECCION PROCEDENCIA">
                                </div>
                            </div>
                            ...
                            <div class="search-box " style="max-width: 100%;">
                                ...
                                <div id="resultadoDistritoActual" class="list-group position-absolute w-100 bg-light overflow-auto" style="z-index:6;max-height: 85px;"> 
                                </div>
                            </div>
                        </div>
                            <div class="col-lg-6 col-sm-12 " >
                            ...
                            <div class="search-box " style="max-width: 100%;">
                                ...
                                <div id="resultadoDistritoProcedencia" class="list-group position-absolute w-100 bg-light overflow-auto" style="z-index:6;max-height: 85px;"> 
                                </div>
                            </div>
                        </div>
